...
Once you have access to {{site.data.keyword.IBM_notm}} Cloudability, you can start by [creating the credentials](/docs/track-spend-with-cloudability?topic=track-spend-with-cloudability-planning) in order to run the deployable architecture. Running the deployable architecture adds your cloud account so you can start tracking your {{site.data.keyword.cloud_notm}} expenses.
